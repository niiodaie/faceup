...
const ResultsPage = () => {
  ...
  /* =====================================================
     TRACK LOCKED CONFIDENCE (EMAIL RETARGETING)
     ===================================================== */
  useEffect(() => {
    if (
      user &&
      entitlements &&
      !entitlements.features?.confidenceScore &&
      entitlements.plan === 'free'
    ) {
      trackEmailEvent({
        event: 'confidence_locked',
        placement: 'results_confidence',
        user,
      });
    }
  }, [entitlements, user]);
      ...
      <div className="max-w-4xl mx-auto">
                ...
                <div className="flex justify-between mb-3">
                  ...
                  {features.confidenceScore ? (
                    ...
                    <div className="relative group">
                      <div className="blur-sm font-bold text-gray-400">92%</div>
                      <button
                        onClick={() => navigate('/pricing')}
                        className="absolute inset-0 opacity-0 group-hover:opacity-100 text-xs bg-white px-2 py-1 rounded shadow"
                      >
                        Unlock Confidence
                      </button>
                    </div>
        ...
        {isGuest && (
          <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-6 text-center">
            <h3 className="font-bold mb-2">Save your results</h3>
            <button
